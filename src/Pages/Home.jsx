          ...
          <div class="col-3">
            <div class="p-3">
              ...
              <Card className="visible" style={{ width: "18rem" }}>          
                <Card.Img className="card-img position-relative" variant="top" src="https://m.media-amazon.com/images/M/MV5BMDBmYTZjNjUtN2M1MS00MTQ2LTk2ODgtNzc2M2QyZGE5NTVjXkEyXkFqcGdeQXVyNzAwMjU2MTY@._V1_.jpg" />
